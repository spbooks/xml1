...
function confirmDelete(processID)
{
	...
	if (confirm(msg))
	{
		location.href = "articletool_delete.php?id=" + processID;
	}
}
</script>
</head>
<body>
<h1><a href="adminindex.php">Main</a>::Article Index</h1>
<br><a href="articletool_create.php">Create New Article</a><br>
...
if (count($listArray)>0){
	foreach ($listArray as $key => $value){
		echo "<li>". $value;
		echo "&nbsp;<a href=\"articletool_edit.php?id=".$key."\">edit</a>&nbsp;";
